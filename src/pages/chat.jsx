...
import { getAgentResponse } from "../services/geminiAiService"; // Import from step 1
import { Send, Bot, Sparkles, ChevronDown, Cpu, Circle } from "lucide-react";
        ...
        {messages.length === 0 ? (
          <div className="h-full flex flex-col items-center justify-center gap-6 opacity-30 select-none">
            ...
            <div className="text-center space-y-2">
              <p className="font-light text-sm uppercase tracking-[0.3em]">
                System Ready
              </p>
              ...
              <div
                ...
                ${
                  m.role === "user"
                    ...
                    : m.role === "system"
                      ? "bg-red-900/10 border-red-900/50 text-red-400 rounded-lg"
        ...
        <div className="relative max-w-3xl mx-auto">
          ...
          <div className="flex items-center gap-2 bg-neutral-950 border border-neutral-800 rounded-xl p-1.5 pl-2 shadow-2xl shadow-black/50 transition-colors focus-within:border-neutral-700">
            ...
            <input
              ...
              placeholder={
                selectedAgent ? "Enter command..." : "Select agent..."
              }
              value={input}
            ...
            <button
              ...
              className={`p-2 rounded-lg transition-all duration-300 ${!input.trim() || loading ? "opacity-20 cursor-not-allowed" : "bg-white text-black hover:scale-105"}`}
            >
          ...
          <p className="text-center text-[9px] text-neutral-700 mt-3 font-mono tracking-wide">
            Powered by Gemini 1.5 Flash // Multi-Agent System
          </p>
        </div>
      </div>
    </div>
